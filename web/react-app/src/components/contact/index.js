    ...
    <div>
      <div className="container mt-3 d-flex flex-column w-50">
        ...
        <Formik
          ...
          onSubmit={({ email, subject, message }, { setSubmitting }) => {
            contactService.sendContactMail({ email, subject, message });
            setSubmitting(false);
          }}
        >
      ...
      <div className="container d-flex justify-content-between my-3">
        ...
        <div>
          <h3>Contact</h3>
          <address>
            Email: <a href="mailto:test@mail.com">info@clinic.com</a>
            <br />
            {/*<br/>*/}
            Phone: <a href="tel:+38501123456">01 / 123 456</a>
            <br />
            {/*<br/>*/}
            Address: Gundulićeva 3, Zagreb
            <br />
            Croatia
          </address>
        </div>
